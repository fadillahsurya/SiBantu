...
export default async function WorkerJobsPage() {
  ...
  return <AppShell role="worker" title="Daftar Order Masuk"><RealtimeOrderList initialOrders={orders} hrefPrefix="/worker/jobs" scope={{ type: "worker", workerId: worker?.id ?? "" }} /></AppShell>;
}
